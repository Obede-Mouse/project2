...
(function($, Raphael, RaphaelExtensions, undefined) {
  ...
  ZONES[UNDERWEIGHT] = 'underweight';
  ZONES[HEALTHY] = 'healthy';
  ZONES[OVERWEIGHT] = 'overweight';
  ZONES[OBESE] = 'obese';
    ...
    init: function() {
      ...
      if (!geom) {
        ...
        this.defaults = {
          ...
          ,
          'width': 250 // The width of the Raphael paper
          ,
          'height': 250 // The height of the Raphael paper
          ,
          'margin': 7
          ...
          'zones': {
            'underweight': {
              ...
              'attr': {
                ...
                'opacity': 0.5,
                'stroke-width': 10 // translates to SVG stroke-width
              }
            },
            'healthy': {
              'show': true,
              'fromPercentage': 0.284,
              'toPercentage': 0.496,
              'attr': {
                'stroke': '#00CA02', // translates to SVG stroke
                'opacity': 1,
                'stroke-width': 10 // translates to SVG stroke-width
              }
            },
